    ...
    return (
        <form className="flex flex-col">
            ...
            <label htmlFor='edad'>
                ...
                <input value={edad} onChange={(e)=>{setEdad(e.target.value)}} className='border border-gray-600'name='edad' type='number' />
            </label>
            {
                esMenorDeEdad ? (<span className='text-3xl text-red-500'>Usted es menor de edad, no puede hacer pagos!</span>):(
